...
SNP_set="/scratch/eld72413/NSFproj/PublishedSNPs/UBC_Dataset_Raw/SAM_lines/UBC_Dataset_SAMlines.recode.vcf"
OUTPUT_DIR="/scratch/eld72413/NSFproj/PublishedSNPs/UBC_Dataset_Raw/SAM_lines"

bcftools stats --threads 4 $SNP_set > ${OUTPUT_DIR}/UBC_SAM_SNPs_filtered_Stats.txt

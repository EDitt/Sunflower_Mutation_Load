...
bcftools filter -i 'COUNT(GT="het")/(N_SAMPLES-N_MISSING) < ${het_prop}' \
${OUTPUT_DIR}/Intermediates/${OUT_PREFIX}_GenoFieldFiltered.vcf \
-o ${OUTPUT_DIR}/Intermediates/${OUT_PREFIX}_HETFiltered.vcf

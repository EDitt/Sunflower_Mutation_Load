...
#Mydf <- Setup_DF("/Users/emilydittmar/Google Drive/Active Projects/DelMutation/Variant_graphs", 
#                   "RawVariants.table", "HCVariants.table")
#names(Mydf)
#names(Mydf$SNP)
